package com.example.android.zldc.io;
...
import com.example.android.zldc.task.HashReceivedCheckTask;
import com.example.android.zldc.util.BuildRandomNumber;
import com.example.android.zldc.util.GzipUtils;
...
public class MqttAndroidConnect extends BaseConnect {
    ...
    public MqttAndroidConnect() {
        ...
        timer=new Timer();
        timer.schedule(hashReceivedCheckTask,1500l,1000l);
    }
        ...
        try {
            ...
            mqttAndroidClient.setCallback(new MqttCallbackExtended() {
                ...
                public void connectComplete(boolean reconnect, String serverURI) {
                    ...
                    LocalData.isConnectService=true;
                    if (reconnect) {
                ...
                public void deliveryComplete(IMqttDeliveryToken token) {
                    try {
                        ...
                        myLog.Write_Log(MyLog.LOG_INFO,"hashException"+e.toString());
                    }
                }
            });
