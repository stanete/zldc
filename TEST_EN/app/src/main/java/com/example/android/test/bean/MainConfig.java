...
//    private MyLog myLog = MyLog.getInstance();
    ...
    public MainConfig(int proVer, int softVer, int chargeOverTempPeriod, int batOverTempPeriod, int socPeriod, long chargeTimePeriod, int infoPeriod, int logPeriod, String ftpUrl, String ftpUser, String ftpPassWord, int ftpPort, String ftpRemoteDir, boolean enableGzip) {
        this.proVer = proVer;
